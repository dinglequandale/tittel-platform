...
// AnswerFormat/Reveal/DEFAULT_CHOICES already live in lesson.ts (ported from
// the same whiteboard vocabulary) — reuse them rather than redeclaring.
import type { AnswerFormat, Reveal } from '../lesson.ts'
export { DEFAULT_CHOICES } from '../lesson.ts'
export type { AnswerFormat, Reveal }
